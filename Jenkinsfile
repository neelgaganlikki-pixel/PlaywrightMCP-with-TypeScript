    ...
    stages {
        ...
        stage('Run Playwright Tests') {
            steps {
                ...
                // workers: 1 is also configured in playwright.config.ts
                // JSON and JUnit reports are generated by Playwright
...
// Jenkins webhook trigger test// Jenkins webhook test - new repository
